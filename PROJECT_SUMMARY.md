...
**Status:** v1.046 (2026-09-22 — **JobShot receiver, steps 1–3**: headless `core/jobshot.py` files a job pushed from the phone, manifest follows the photo rename, archive day-rule wins over `work_date` (Nick's call) · builds on v1.045: photos named after their folder · tests 52/52 · last released build = v1.045)
