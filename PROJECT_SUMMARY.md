...
**Status:** v1.049 (2026-09-23 — **LAN receiver: a job sent from the phone over Wi-Fi**, paired by QR, filed by the same path as a dropped folder · **built for testing, NOT released** — last released build is v1.047 · builds on v1.047 (three ways to import a job by hand) and v1.045 (photos named after their folder) · tests 92/92)
